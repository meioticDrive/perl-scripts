...
my(@reference_file, $ref_file_number, $oligo_size, $oligo_sequence, $position, $oligo_temp,
...
for (my $position = 0; $position < ($reference_seq_size - $oligo_size); $position++) {
	...
	print IN_EXACT_MATCH_IN "rp11-489k19.txt\n";
	...
	print IN_EXACT_MATCH_IN "11\n";
	print IN_EXACT_MATCH_IN "Put the $oligo_sequence here\n";

	# Call the exact_match program
	# system (exact_match < in.jen.in"
}
