...
my(@experimental_files, @reference_file, @ref_seq, $exp_file_number, $ref_file_number, $reference_seq, $reference_seq_size,
@ref_compare, $experiment_sequence, $experiment_sequence_size, @experiment_compare, $bases_identical, $bases_different, 
