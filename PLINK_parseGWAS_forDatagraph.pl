...
# 05/13/2014
################################################################################
# PLINK_parseGWAS_forDatagraph.pl
# Program designed to generate and format PLINK GWAS data output for easy entry # into DataGraph
# 1. Parse SNP IDs and p-values from plink logistic file
# 2. Determines start/stop bounds for each chromosomes
#
# Future Updates
# 1. Capture file name from test before *.assoc.logistic file
...
open(OUT_LOG, ">>", "log.association.parsed.txt")
	or die "Cannot open OUT_LOG for data output";

# Obtain name of plink files
@plink_file = glob("*.assoc.logistic");
...
print "Detected $plink_file_number *.assoc.logistic.txt file\n";
print OUT_LOG "Detected $plink_file_number *.assoc.logistic.txt file\n";

# Open output file for complete association data
open (OUT_ANNOT, ">>", "association.parsed.txt")
...
# Process plink logistic.association file
