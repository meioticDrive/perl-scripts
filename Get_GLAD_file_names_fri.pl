...
my($data_file_number, $sample_IDs_number, $total_files, $m, $n, $total_source, $test, $data);
...
foreach $data (@data_files) {
	...
	@name = split (/\./, $data);
	print "The sample ID is: $name[1]\n";
	push (@sample_IDs, $name[1]);
}
...
print "Number of source files is $test";
