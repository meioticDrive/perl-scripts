#!/usr/bin/perl
#
# Name: RA_sort_multifasta.pl
# Version: 1.0
# Date: 03/16/2007
# Author: Michael E. Zwick
#-----------------------------------------------------------------------------
# 1. The purpose of this script sort the fasta fragments in a multi-fasta file by fasta label. 
# This is used in the instances where the .cdf or .ndf file information is not in the same 
# order as the genome reference sequence.
# 2. Fasta file output has .sort.fasta appended to the end of the original file name
#-----------------------------------------------------------------------------
use warnings;
use strict;
use Cwd;
